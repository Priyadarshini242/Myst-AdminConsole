...
const SkillSearchDashboard = () => {
  ...
  return (
    <div className="">
      ...
      {/* <SkillSeekerSearch SkillBasedResult={SkillBasedResult} contentHeight={"84vh"} /> */}
      <SkillSeekerSearchArea
...
export default SkillSearchDashboard;
