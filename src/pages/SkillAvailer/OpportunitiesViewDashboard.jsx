...
import JdListGrid from './JD Components/JdListGrid';
import JdInfoTabsSection from '../../components/SkillAvailer/JdInfoTabsSection';
import JdMiddleSlider from '../../components/SkillAvailer/JDRelatedComponents/JdViewDashboardComponents/JdMiddleSlider';
import ToggleBtn from '../../components/Buttons/ToggleBtn';
import { icons } from '../../constants';
import { useSelector, useDispatch } from 'react-redux';
import { useNavigate } from 'react-router-dom';
import useContentLabel from '../../hooks/useContentLabel';
import CreateOpportunity from '../../components/SkillAvailer/Opportunity Creation/CreateOpportunity';
import useMediaQuery from '../../hooks/useMediaQuery';


const OpportunitiesViewDashboard = () => {
        ...
        >
          {viewMode !== "form" ? (
            <React.Fragment>
              ...
              >
                <div
                  className="card nav header-nav d-flex justify-content-center "
                  id="nav-tab"
                >
                  <div className="d-flex gap-2 align-items-center " style={{padding:'0.75rem 1rem'}}>
                    <div className="font-3 ">
                    {contentLabel('OpportunityInformation', 'nf Opportunity Information')}
                      {/* {jdStore?.SelectedJd && jdStore.SelectedJd.title} */}
                    </div>
                    {viewMode === "single" && (
                      <icons.IoClose
...
export default OpportunitiesViewDashboard;
