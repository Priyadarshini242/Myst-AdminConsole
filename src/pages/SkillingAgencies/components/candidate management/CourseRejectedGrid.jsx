...
const CourseRejectedGrid = ({ toolbarStatus = true, handleSwitchPane , SelectedOp }) => {
...
//  useEffect(() => {
//         setData(courseAppList?.filter(x=>x.status?.toLowerCase()==="rejected"));
//     }, [courseAppList]);
...
//whenever response api is called the questions of thje jd is acquired and stored in a array 
  ...
  useEffect(() => {
    ...
    const table = useMaterialReactTable({
        ...
        data:courseAppList?.filter(x=>x.status?.toLowerCase()==="rejected"),
...
export default React.memo(CourseRejectedGrid);
