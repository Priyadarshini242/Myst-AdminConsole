...
const ResumeMember = ({ conf, setResumeConf, index }) => {
            ...
            <div class="accordion w-100 resumeAccordion" id="accordionPanelsStayOpenExample">
                <div class="accordion-item  ">
                    <h2 class="accordion-header ">
                        ...
                        >
                            {contentLabel('Membership', 'nf Membership')}-{index + 1}
                        </button>
                    </h2>
                    <div
                            ...
                            >

                                {
                                  ...
                                  <Col md={6} xs={12}   className="mb-2">
                                    <label htmlFor="" className="form-label"> {contentLabel('MembershipName', 'nf Membership Name')}<span className="text-danger ms-1">*</span></label>
                                    <input
                                        type="Text"
                                        class="form-control"
                                        id="cert-name"
                                        placeholder="Enter your membership name"
                                        value={conf?.membershipName}
                                        onChange={(e) => {
                                            setResumeConf((prevSkillings) => {
                                                return prevSkillings.map((item) =>
                                                    item.id === conf.id
                                                        ? { ...item, membershipName: e.target.value }
                                                        : item
                                                );
                                            });
                                        }}
                                    />
                                    <InputLimit value={conf?.membershipName} />
                                </Col>
    ...
    ?.join(" ")
          ...
          <span style={{ color: "var(--primary-color)" }}>{contentLabel('Create', 'nf Create')}</span>
                                    ...
                                    <Col xs={6} className="pe-1 pe-md-3">
                                        <div className="mb-3 d-flex flex-column justify-content-between">
                                            <label className="text-label form-label d-flex align-items-center white-space-no-wrap">
                                                {contentLabel("ProjecStart", "nf From")}{" "}
                                                <span className="text-danger ms-1">*</span>
                                            </label>
                                ...
                                <Col xs={12}>
                                    <BriefDescriptionTextArea
                                        label={contentLabel(
                                            "BriefDescriptionAboutMem",
                                            "nf Brief Description About Membership"
                                        )}
