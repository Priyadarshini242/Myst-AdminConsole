...
const ResumeLice = ({ conf, setResumeConf, index }) => {
  ...
  useEffect(() => {
    ...
    accordionStates[conf.id]?.institutionFirstWord,
    conf.id,
    selectedLanguage,
    conf?.edit,
  ]);
  ...
  return (
    <div className="d-md-flex d-block gap-2 align-items-start">
      <input
        ...
        name=""
        id=""
        checked={conf?.active || conf?.import}
      ...
      <div class="accordion w-100 resumeAccordion" id="accordionPanelsStayOpenExample">
        <div class="accordion-item  ">
          <h2 class="accordion-header ">
            ...
            >
              {contentLabel("License", "nf License")}-{index + 1}
            </button>
          </h2>
          <div
              ...
              >
                {conf?.import && (
                  ...
                  <label htmlFor="" className="form-label">
                    {" "}
                    {contentLabel("LicenseName", "nf License Name")}
                  ...
                  <input
                    ...
                    class="form-control"
                    id="cert-name"
                    placeholder="Enter your Licences name"
                    value={conf?.licensesName}
                    onChange={(e) => {
                      setResumeConf((prevSkillings) => {
                        return prevSkillings.map((item) =>
                          item.id === conf.id
                            ? { ...item, licensesName: e.target.value }
                            : item
                        );
                      });
                    }}
                  />
                  <InputLimit value={conf?.licensesName} />
                </Col>
                ...
                <Col md={6} xs={12} >
                  ...
                  <div className="w-100">
                    ...
                    styles={customStylesForReactSelect}
                      ...
                      options={(() => {
                        const options =
                          accordionStates[conf.id]?.educationSuggestionsData ||
                          [];
    ...
    ?.join(" ")
          ...
          <span style={{ color: "var(--primary-color)" }}>{contentLabel('Create', 'nf Create')}</span>
                  ...
                  <Col xs={6} className="pe-1 pe-md-3">
                    <div className="mb-3 d-flex flex-column justify-content-between">
                      <label className="text-label form-label d-flex align-items-center white-space-no-wrap">
                        {contentLabel("DateOfIsuue", "nf Date Of Isuue")}
                        <span className="text-danger ms-1">*</span>
                      </label>
                        ...
                        <DatePicker
                          ...
                          selected={
                            conf?.startYear
                              ? new Date(
                                  parseInt(
                                    new Date(conf?.startYear, 0, 1).getTime()
                                  )
                                )
                              : null
                          }
                  ...
                  <Col xs={6} className="pe-1 pe-md-3">
                    <div className="mb-4 d-flex flex-column justify-content-between">
                      <label className="text-label form-label d-flex justify-content-between align-items-center white-space-no-wrap">
                        <div>
                          {contentLabel("Validity", "nf Validity")}
                          <span className="text-danger ms-1">*</span>
                  ...
                  <Col xs={6} className="ps-1 ps-md-3">
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          {contentLabel("DoesnotExpire", "nf Doesn't Expire")}
                        </label>
                      </div>
                    </label>
                    <div className="mb-4 d-flex flex-column justify-content-between">
                ...
                <Col xs={12}>
                  <BriefDescriptionTextArea
                    label={contentLabel(
                      "BriefDescriptionAboutLicense",
                      "nf Brief Description About License"
                    )}
                    htmlFor={"LicenseBriefDescription"}
                    textareaClass={""}
                    id={"LicenseBriefDescription"}
