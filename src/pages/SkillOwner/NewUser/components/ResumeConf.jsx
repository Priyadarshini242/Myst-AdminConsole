...
const ResumeSkilling = ({ conf, setResumeConf, index }) => {
  ...
  return (
    <div className="d-md-flex d-block align-items-start gap-2">
      ...
      />
      <div class="w-100 accordion resumeAccordion" id="accordionPanelsStayOpenExample">
            ...
            <button
              ...
              onClick={() => {
                if (!accordionStates[conf.id]?.isOpen) {
                  ...
                  updateAccordionState(conf.id, "institutionFirstWord", conf?.institution || "");
                  updateAccordionState(conf.id, "institution", conf?.institution || "");
                }
              }}
            >
              {contentLabel('Conference', 'nf Conference')}-{index + 1}
            </button>
          </h2>
          <div
          ...
          >
            <div class="accordion-body" style={{
              ...
              >
                ...
                {
                  conf?.import &&
                  <div className="d-flex justify-content-end text-primary-color fw-bold" style={{ top: '1.3rem', right: '2rem' }}>{contentLabel('Imported', 'nf Imported')}</div>
                }

                   <Col  md={6} xs={12}  className=" mb-2">
                  <label htmlFor="" className="form-label"> {contentLabel('ConferenceName', 'nf Conference Name')}<span className="text-danger ms-1">*</span></label>
                  <input
                    type="Text"
                    class="form-control"
                    id="cert-name"
                    ...
                    onChange={(e) => {
                      setResumeConf((prevSkillings) => {
                        return prevSkillings.map((item) =>
                          item.id === conf.id
                            ? { ...item, conferenceName: e.target.value }
                            : item
                        );
                      });
                    }}
                  />
                  <InputLimit value={conf?.conferenceName} />
                </Col>
                ...
                <Col md={6} xs={12} className="mb-4">
                  ...
                  <CreatableSelect
                    ...
                    value={
                      accordionStates[conf.id]?.institution
                        ? {
                          label: accordionStates[conf.id]?.institution,
                          value: accordionStates[conf.id]?.institution,
                        }
                        : null
                    }
                    // menuIsOpen={true}
                ...
                <Col xl={12} lg={12} className="d-flex justify-content-between">
                  ...
                  <Col xs={6} className="pe-1 pe-md-3">
                    <div className="d-flex flex-column justify-content-between mb-3">
                      <label className="d-flex form-label align-items-center text-label white-space-no-wrap">
                        {(
                          ...
                          "nf When did you start your Conference "}{" "}
                        <span className="text-danger ms-1">*</span>
                      </label>
                  ...
                  <Col xs={6} className="ps-1 ps-md-3">
                    <div className="d-flex flex-column justify-content-between mb-4">
                      <label className="d-flex form-label align-items-center text-label">
                        &nbsp;
                      </label>
                ...
                <Col lg={12} className="d-flex justify-content-between">
                  ...
                  <Col xs={6} className="pe-1 pe-md-3">
                    <div className="d-flex flex-column justify-content-between mb-4">
                      <label className="d-flex form-label align-items-center justify-content-between text-label white-space-no-wrap">
                        <div>
                          {(
                            content[selectedLanguage]?.find(
                  ...
                  <Col xs={6} className="ps-1 ps-md-3">
                    <label
                      ...
                      className="d-flex form-label justify-content-between"
                    >
                      &nbsp;
                      <div
                        className={
                ...
                <Col lg={6}>
                  <div className="mb-4">
                    <label className="d-flex form-label justify-content-between text-label">
                ...
                <Col className="col-12 mb-3">
                  <BriefDescriptionTextArea
                    label={contentLabel(
                      "BriefDescConf",
                      "nf Brief decription about conference"
                    )}
