...
import ConferenceSummary from "../../../components/SkillOwner/DetailedProfile/ConferenceSummary";
import ConferenceDetail from "../../../components/SkillOwner/DetailedProfile/ConferenceDetail";
...
const ConferenceHistory = () => {
  ...
  const checkDuplicate = () => {
    ...
    conferenceHistory?.data?.map((cert) => {
      if (
        cert.title === skillingDetails?.conferencesName &&
      ...
      showErrorToast(
        (
          content[selectedLanguage]?.find(
            (item) => item.elementLabel === "ConferenceAlreadyexistDate"
          ) || {}
        ).mvalue || "nf Conference already exist in within the date range"
      );
      return;
    }
                    ...
                    <div className=" ">
                      <div class="mb-2 ">
                        ...
                        <input
                          type="text"
                          style={{ height: "32px" }}
                          name="conferencesName"
                          class="form-control bg-body-tertiary h-75 "
                          id=""
                          placeholder=""
                          value={skillingDetails?.conferencesName}
                          onChange={(e) =>
                            setSkillingDetails({
                              ...skillingDetails,
                ...
                <>
                  ...
                  >
                    <div className="accordion-item border-0  mb-2 rounded-top  ">
                      <h2 className="accordion-headerc  py-1">
                        <button
                        ...
                        >
                          <div className="w-75">
                            ...
                            {(
                              content[selectedLanguage]?.find(
                                (item) =>
                                  item.elementLabel === "ConferenceHistory"
                              ) || {}
                            ).mvalue || "nf Conference History"}
                          </div>
