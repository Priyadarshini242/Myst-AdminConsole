...
const ForgotPasswordWithAltEmail = () => {
              ...
              <div class="login d-flex flex-column  pt-5 ">
                ...
                {!steps.step1 && (
                  <div class="container m-auto mt-5">
                    <div class="row">
                      <div class="col-lg-12  mx-auto d-flex flex-column justify-content-center align-items-center ">
                        ...
                        {!primaryEmail ? (
                          <>
                            ...
                            >
                              {" "}
                              <span className="fw-bold">Don't worry! </span>We
                              can get your alternate email by your registered
                              email
                            </p>
                            <div className="d-flex px-4  justify-content-center  align-items-center gap-2 mb-3">
                              ...
                              <button
                                id="signInBtn"
                                class="btn  btn-block my-0 rounded-pill shadow-sm text-white py-1  "
                                style={{
                          ...
                          <>
                            ...
                            >
                              {" "}
                              <span className="fw-bold">Don't worry! </span>We
                              can verify your identity with your alternate email
                              address
                            </p>
                            <div className="d-flex px-4  justify-content-center  align-items-center gap-2 mb-3">
                        ...
                        <Link
                          to="/forgotpassword-noaccess"
                          class=" text-muted mb-5 text-center m-auto"
                          style={{
                            letterSpacing: ".06rem",
...
export default ForgotPasswordWithAltEmail;
